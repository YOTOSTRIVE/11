...
{   
    ...
    double speed = (double)req.mvvelo*50000;
    double accel = (double)req.mvacc*3000;
...
{   
    ...
    double speed = (double)req.mvvelo*20;
    double accel = (double)req.mvacc*4;

    OptionalCond* p = nullptr;

    int sdk_res = robot.joint_move(&joint_pose,MoveMode::ABS,is_block,speed,accel,0.1,p);
